...
import com.smartexpense.notificationservice.entity.ProcessedEvent;
...
class ProcessedEventServiceTest {
    ...
    void processIdempotently_runsActionAndRecordsEvent() {
        ...
        processedEventService.processIdempotently("evt-1", "BudgetExceeded", () -> executed[0] = true);
        ...
        assertThat(captor.getValue().getEventType()).isEqualTo("BudgetExceeded");
    }
    ...
    void processIdempotently_skipsDuplicateEvent() {
        ...
        processedEventService.processIdempotently("evt-1", "BudgetExceeded", () -> {
