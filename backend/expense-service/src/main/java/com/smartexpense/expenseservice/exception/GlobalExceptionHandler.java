...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleExpenseNotFound(ExpenseNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new MessageResponse(ex.getMessage()));
    }

    @ExceptionHandler(MissingAddedEventIdException.class)
    public ResponseEntity<MessageResponse> handleMissingAddedEventId(MissingAddedEventIdException ex) {
